...
- **NO@10**: best at γ=0.643, ρ=10, NO=0.2114
- **NO@30**: best at γ=0.429, ρ=10, NO=0.2152
- **NO@100**: best at γ=0.214, ρ=30, NO=0.3308

## How the optimum moves with target k

- γ* ranges 0.21→0.64 as k grows; ρ* ranges 10→30.
...
- **AUC NO@k near-local (k=1..10)**: best at γ=1.071, ρ=10, AUC=0.2900
- **AUC NO@k mid-local (k=11..90)**: best at γ=0.429, ρ=10, AUC=0.2436
