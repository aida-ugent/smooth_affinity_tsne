...
- **NO@10**: best at γ=0.643, ρ=10, NO=0.4708
- **NO@30**: best at γ=0.214, ρ=10, NO=0.5131
...
- **AUC NO@k near-local (k=1..10)**: best at γ=1.071, ρ=10, AUC=0.4895
- **AUC NO@k mid-local (k=11..90)**: best at γ=0.214, ρ=10, AUC=0.5343
