...
- **NO@10**: best at γ=0.750, ρ=15, NO=0.4660
- **NO@30**: best at γ=0.375, ρ=15, NO=0.5062
- **NO@100**: best at γ=0.000, ρ=30, NO=0.6142
...
- **AUC NO@k near-local (k=1..10)**: best at γ=1.500, ρ=15, AUC=0.4878
- **AUC NO@k mid-local (k=11..90)**: best at γ=0.375, ρ=15, AUC=0.5340
