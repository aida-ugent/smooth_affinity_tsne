...
- **NO@10**: best at γ=0.857, ρ=150, NO=0.8756
- **NO@30**: best at γ=0.857, ρ=200, NO=0.8911
- **NO@100**: best at γ=0.857, ρ=200, NO=0.9004

## How the optimum moves with target k

- γ* ranges 0.86→0.86 as k grows; ρ* ranges 150→200.
...
- **AUC NO@k near-local (k=1..10)**: best at γ=0.857, ρ=200, AUC=0.8613
- **AUC NO@k mid-local (k=11..90)**: best at γ=0.857, ρ=200, AUC=0.8936
