...
Usage
-----
    python compare_affinity_variants.py --dataset mnist   # -> results/affinity_comparison_mnist
    python compare_affinity_variants.py --dataset mouse
    python compare_affinity_variants.py --dataset adult
    python compare_affinity_variants.py --dataset mnist --plot_only
"""
...
def parse_args():
    ...
    p.add_argument("--out_dir",          default=None,
                   help="Output directory (default: results/affinity_comparison_<dataset>)")
...
def main():
    ...
    out_dir = args.out_dir or os.path.join(_SCRIPT_DIR, "results", f"affinity_comparison_{args.dataset}")
